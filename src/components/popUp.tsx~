      ...
      <div
        ...
        <div
          ...
          <div className="flex flex-col gap-3">
            ...
            <p
              className={
                "leading-[1.5] text-center font-medium text-[18px]  text-[#E0E0E0]"
              }
            >
          ...
          <div className="">
            ...
            >
              ...
              >
                ...
                >
                  <Input.Password
                    ...
                    style={{padding: "14px 16px"}}
                    prefix={
                      <img src={"public/lockIcon.svg"} alt="icon of person"/>
                    }
                  />
                </Form.Item>
                <Form.Item<FieldType>
                ...
                >
                  <Checkbox style={{color: "#9C9C9C", fontSize: "16px"}}>
                    Запомнить данные
                  </Checkbox>
                </Form.Item>
                ...
                <Form.Item style={{marginBottom: 16}}>
                  <div className="w-[400px]">
                    <Button
                      ...
                      block
                      className={
                        " bg-[#242EDB]! bg-gradient-to-t! from-[rgba(255,255,255,0]! to-[rgba(255,255,255,0.12)]! rounded-[12px]! border-1! border-[#367AFF]! hover:opacity-80 active:opacity-90"
                      }
                    >
                      Войти
                    </Button>
              ...
              <div className="relative  flex  flex-row gap-[10px] items-center">
                ...
                <span
                  className={
                    "bg-linear-to-t text-transparent h-fit from-[rgba(206,206,206,1)] to-[rgba(176,176,176,1)] bg-clip-text"
                  }
                >
                  или
                </span>
              ...
              <div className="mt-4 text-[#6C6C6C] leading-[1.5] font-normal text-center">
                Нет аккаунта?{" "}
                <span className={"text-[#242ED8] cursor-pointer"}>Создать</span>
              </div>
            </ConfigProvider>
          </div>
        </div>
