...
function MainTable() {
  ...
  function AddButton() {
    return <Button variant={"filled"} className={"w-[52px]! h-[26px]! rounded-[23px]! bg-[#242EDB]!"}><img
      alt={"plus icon"}
      src={"/public/plusIcon.svg"}/></Button>
  }


  function MoreButton() {
    return <Button
      className={"rounded-full! border-none! size-[26px]! p-0! border-[#B2B3B9] flex! justify-center! items-center!"}>
      <img alt={"more icon"}
           className={"size-[26px]"}
           src={"/public/moreIcon.svg"}/></Button>
  }
  ...
  function AddNewItemPopUp() {
    return (
      <div className={"absolute z-99 top-0 left-0 w-full h-screen flex justify-center items-center bg-gray-800/40"}
          ...
          <div
            ...
            <div
              ...
              <div className="flex flex-col gap-3">
                <h2 className={"text-[#232323] font-semibold text-[40px] leading-[1.1] tracking-[-0.015em] "}>Добавить
                  новую позицию</h2>
              ...
              <div className="">
                <ConfigProvider theme={{
                  ...
                  <Form className={"w-[400px] mt-10! leading-[1.5]"} layout={"vertical"}
                        onFinish={createItem} requiredMark={false}>
                    <Form.Item<FieldType>
                    ...
                    >
                      ...
                      <Input
                        ...
                        allowClear={{
                          clearIcon: <div className={"w-4 h-4"}><img src={"public/crossIcon.svg"} alt={"cross icon"}/>
                          </div>
                        }}
                    ...
                    <Form.Item<FieldType>
                      ...
                      label={"Вендор"}
                      name={"vendor"}
                      rules={[{required: true, message: "Введите название вендора"}]}
                    >
                    ...
                    <Form.Item style={{marginBottom: 16}}>
                      <div className="w-[400px]">
                        <Button htmlType={"submit"} type={"primary"} block
                                className={" bg-[#242EDB]! mt-5 bg-gradient-to-t! from-[rgba(255,255,255,0]! to-[rgba(255,255,255,0.12)]! rounded-[12px]! border-1! border-[#367AFF]! hover:opacity-80 active:opacity-90"}>Создать</Button>
                      </div>
                    </Form.Item>
  ...
  const columns = [
    {
      ...
      render: (title: string, record: Product) => {
        return (<div className={"w-[278px h-12 flex gap-[18px] items-center"}>
          <div className="size-12 rounded-lg border-1 border-[#ECECEB] bg-[#C4C4C4]"></div>
          <div className="flex flex-col gap-[10px]">
            <h5 className={"font-cairo font-bold text-[16px]  leading-none h-auto"}>{title}</h5>
            <p className={"text-[#B2B3B9] font-cairo text-[14px] font-normal leading-none"}>{record.category}</p>
          </div>
        </div>)
      },
    ...
    },
    {
      ...
      render: (brand: string) => {
        return (
          <p className={"font-openSans font-bold text-[16px] leading-none"}>{brand}</p>
        )
      }
      ,
...

    {
      ...
      render: (sku: string) => {
        return (
          <p className={"font-openSans font-normal text-[16px] leading-none"}>{sku}</p>
        )
      },
    ...
    },
    {
      ...
      render: (rating: number) => {
        return (
          <>{rating < 3 ?
            <p className={"font-openSans font-normal text-[16px] leading-none"}><span
              className={"text-[#F11010]"}>{rating}</span>/5</p> :
            <p className={"font-openSans font-normal text-[16px] leading-none"}>{rating}/5</p>}</>
        )
      },
      ...
      <section>
        ...
        <div className="mt-5 bg-white px-[30px] py-[26px] f-full flex justify-between">
          ...
          <div className="w-[1023px] h-[48px]">
            <Input placeholder={"Найти"}
                   ...
                   prefix={<img src={"public/magnifyingGlassLogo.svg"} alt="icon of magnifyingGlass"/>}
        ...
        <div className="w-full h-full mt-[13px] bg-white pt-11 px-[30px] pb-[37px]">
          <div className=" flex justify-between items-center">
            <h4 className={"font-cairo font-bold text-[20px] leading-1 tracking-[0]"}>Все позиции</h4>
            <div className="flex gap-2">
              <Button type={"default"}
                      className={" p-0!  bg-white! border-1! border-[#ECECEB]! size-[42px]! flex items-center justify-center hover:shadow-sm"}>
              ...
              <Button type={"default"}
                      ...
                      variant={"filled"}
                      className={"bg-[#242EDB]! px-5! h-[42px]! text-[#EBF3EA]! font-cairo! font-semibold! text-[14px]! flex gap-[15px]!"}>
                <img src={"public/plusInCircleIcon.svg"} className={"size-[22px]"} alt="icon of plus"/>
                Добавить
              </Button>
          ...
          <ConfigProvider theme={{
            ...
            <Table rowSelection={{
              columnWidth: 58,
              columnTitle: <Checkbox className="no-tick" onChange={handleSelectAll}/>,
              renderCell: (_, record) => <Checkbox className="no-tick"
              ...
              />
                   ...
                   loading={isLoading}
                   className={"mt-10"}
                   dataSource={items?.products} columns={columns}
                   pagination={{

                     defaultPageSize: 5,
                     showTotal: (total, range) => <div
                       className="absolute!  font-roboto left-0 font-normal text-[#969B9F]">
                       Показано{" "}
                       <span className=" text-[#333] font-normal">{range[0]}-{range[1]}</span>{" "}
